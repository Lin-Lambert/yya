...
<body class="pos-r">
	...
	<div style="margin-left: 200px;">
		<nav class="breadcrumb">
			...
			商品管理 <span class="c-gray en">&gt;</span> 新增商品 <a
		...
		<div class="page-container">
			<form  id="form-article-add" action="/restful/page/product" method="post" class="form form-horizontal">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" name="price" id="price" placeholder="填入商品展示价格(单位:分)" value="" class="input-text" style="width:50%">
					</div>
				</div>
				...
				<div class="row cl">
					<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
						...
						<input onClick="layer_close();" class="btn btn-default radius" type="reset" value="&nbsp;&nbsp;重置&nbsp;&nbsp;">
					</div>
				</div>
			</form>
		</div>
...
function article_save_submit(){
	...
	$.ajax({
	   ...
	   success: function(msg){
		   layer.msg('新增商品成功!',{icon:1,time:1000},function () {
