package com.lambert.order.dao;


import com.lambert.order.bean.Where;
import org.springframework.beans.factory.annotation.Autowired;

import com.lambert.order.mapper.OrderMapper;
...
public class OrderDAO implements IOrder{
	...
	@Override
	public PageResult<Order> queryOrderByUserNameAndPage(Long userId, Integer page, Integer count) {
		...
		PageList<Order> list = this.orderMapper.queryListByWhere(bounds, Where.build("userId", userId));
