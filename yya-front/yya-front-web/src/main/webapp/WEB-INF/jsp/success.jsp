...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <style type="text/css">
	  .progress .progress-1{background:url(../images/step3.png) no-repeat;width:481px;padding-top:23px;overflow:hidden;height:23px;}
	  ...
	  .progress li.step-1{color:#aaaaaa;}
	  .progress li.step-2{color:#aaaaaa;width:161px;}
	  .progress li.step-3{color:#7abd54;}
...
<div class="w" id="headers">
		<div id="logo"><a href="/"><img alt="商品商城" src="/mycart/images/reglogo.png"></a></div>
