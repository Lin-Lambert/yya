    ...
    <script>
        function submit(){
            ...
            $(".checkbox:checked").each(function () {
                pids += $(this).attr("productId") + ",";
            })
            window.location="http://www.youyijia.com/order/toOrder.html?pids=" + pids;
        }
    </script>
<body> 
<!--shortcut start-->
...
<div class="cart-inner">
    ...
    <div id="product-list" class="cart-tbody">
        ...
        <c:if test="${empty cartList}">
            <div style="text-align: center;font-size: 20px;margin-top: 20px;margin-bottom: 20px;"><a href="/" >请添加商品到购物车</a></div>
        </c:if>
        <c:forEach items="${cartList}" var="cart">
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            <div class="cell p-checkbox"><input data-bind="cbid:1" class="checkbox" productId="${cart.productId}" type="checkbox" name="checkItem" checked="" value="11345721-1"></div>
		            <div class="cell p-goods">
		                <div class="p-img">
		                	<a href="http://www.youyijia.com/product/${cart.productId }.html" target="_blank">
		                		<img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.productImage}" alt="${cart.productTitle}" width="52" height="52">
		                	</a>
		                </div>    
		                <div class="p-name">
		                	<a href="http://www.youyijia.com/product/${cart.productId }.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.productTitle}</a>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              ...
              <span class="shopping">
                  <b>                  </b>
                  <a href="http://www.youyijia.com/" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>              </span>          </div>
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <c:if test="${!empty cartList}">
                        <a class="checkout" href="#" onclick="submit();return false;" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement" style="margin-top: -14px;border: 2px solid #ddd;">去结算<b></b></a>                  </span>
                      </c:if>
