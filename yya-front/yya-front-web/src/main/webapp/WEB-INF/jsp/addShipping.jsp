...
<div class="container w">
  <div class="main clearfix" id="form-main">
    <div class="reg-form fl">
      <form action="/order/doAddShipping.html" id="shipping-form" method="post">
        ...
        <div class="form-item">
          ...
          <input type="text" name="name" id="form-pwd" class="field" maxlength="20" placeholder=" " default="&lt;i class=i-def&gt;&lt;/i&gt;建议使用字母、数字和符号两种及以上的组合，6-20个字符">
          <i class="i-status"></i>
        </div>
        ...
        <div class="form-item">
          <label>手机号码</label>
          <txt style="position: absolute; z-index: 2; line-height: 46px; margin-left: 20px; margin-top: 1px; font-size: 14px; font-family: &quot;Microsoft YaHei&quot;, &quot;Hiragino Sans GB&quot;; color: rgb(204, 204, 204); display: inline;">  </txt>
          <input type="text" name="phone" id="form-equalTopwd" class="field" placeholder=" " maxlength="20">
          <i class="i-status"></i>
        </div>
        <div class="input-tip"> <span></span> </div>
        <div class="form-item form-item-account" id="form-item-account">
          <label>固定电话</label>
          <txt style="position: absolute; z-index: 2; line-height: 46px; margin-left: 20px; margin-top: 1px; font-size: 14px; font-family: &quot;Microsoft YaHei&quot;, &quot;Hiragino Sans GB&quot;; color: rgb(204, 204, 204); display: inline;">   </txt>
          <input type="text" id="form-account" name="mobile" class="field">
        ...
        <div class="form-item form-item-account" id="form-item-account">
          <label>收货地址</label>
          <txt style="position: absolute; z-index: 2; line-height: 46px; margin-left: 20px; margin-top: 1px; font-size: 14px; font-family: &quot;Microsoft YaHei&quot;, &quot;Hiragino Sans GB&quot;; color: rgb(204, 204, 204); display: inline;">   </txt>
          <input type="text" id="form-account" name="address" class="field">
          <i class="i-status"></i> </div>
        <div class="input-tip"> <span></span> </div>
        <div class="form-item form-item-account" id="form-item-account">
          <label>邮政编码</label>
          <txt style="position: absolute; z-index: 2; line-height: 46px; margin-left: 20px; margin-top: 1px; font-size: 14px; font-family: &quot;Microsoft YaHei&quot;, &quot;Hiragino Sans GB&quot;; color: rgb(204, 204, 204); display: inline;">   </txt>
          <input type="text" id="form-account" name="zip" class="field">
          <i class="i-status"></i> </div>
        <div class="input-tip"> <span></span> </div>
        <div>
